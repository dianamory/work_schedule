...
if st.session_state.authenticated:
      ...
      # Minimum number of members filter
      st.sidebar.subheader('Filtrar por cantidad')
      num_unique_names = df['Nombre'].nunique()
      min_members = st.sidebar.number_input(label='', min_value=2, max_value=df['Nombre'].nunique(), value=min(2, num_unique_names), step=1,label_visibility='collapsed')
